...
const TruckInfoAdd = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post("http://localhost:5000/trucks", truck)
      .then(() => navigate("/"))
  ...
  return (
    <form onSubmit={handleSubmit}>
      <h2>Add New Truck</h2>
      {["truck_name", "truck_status", "empty_weight", "company", "gvw", "reg_date", "truck_owner_name", "owner_id", "tax_validity", "insurance_validity", "fitness_validity", "permit_validity", "direct_sale"].map((field) => (
