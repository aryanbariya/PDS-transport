...
const MSWCGodownForm = ({ onClose, onSave, editData }) => {
  ...
  const handleChange = (e) => {
    ...
    setFormData({
      ...formData,
      [name]: value.charAt(0).toUpperCase() + value.slice(1), // Auto-capitalize first letter
    });
  };
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-60 z-50">
      <div className="bg-white rounded-lg shadow-lg w-4/5 max-w-3xl p-8">
        <h2 className="bg-gradient-to-r from-white-600 to-white-800 text- text-xl font-semibold py-4 px-6 rounded-t-lg text-center">
