...
//             <th className="px-4 py-3">Parent Godown</th>
//             <th className="px-4 py-3">Sub Godown Name</th>
...
//               <td className="px-4 py-3">{g.parentGodown}</td>
//               <td className="px-4 py-3">{g.subGodown || "N/A"}</td>
//               <td className="px-4 py-3">{g.status || "N/A"}</td>
